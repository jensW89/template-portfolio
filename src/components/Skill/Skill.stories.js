...
stories.add(
  "Skill component to describe a develop disciplin (FRONTEND)",
  () => (
    <Skill
...
stories.add("Skill component to describe a develop disciplin (BACKEND)", () => (
  <Skill
...
stories.add(
  "Skill component to describe a develop disciplin (METHODOLOGIES)",
  () => (
    <Skill
